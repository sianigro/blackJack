    ...
    deal() {
     ...
     setTimeout(() => {
      ...
      if(this.playerScore == 21 || this.dealerScore == 21) {
          ...
          if(this.playerScore == 21 && this.dealerScore == 21) {
          ...
          } else { // if only one hand got dealt Blackjack, we have a winner
             ...
             if(this.playerScore == 21) {
                ...
                // optional: if player ONLY has blackjack but dealer had potential blackjack, then turn over the Hole Card.
